...
public class ExportXML implements ExportVisitor {

	@Override
	public void ExportLine(Line shape) {
		System.out.printf("<graphObject type=\"%s\" x1=\"%d\" y1=\"%d\" x2=\"%d\" y2=\"%d\" color=\"%s\" />", 
	...
	public void ExportCircle(Circle shape) {
		System.out.printf("<graphObject type=\"%s\" x=\"%d\" y=\"%d\" r=\"%d\" color=\"%s\" />", 
				shape.getClass().toString(),
	...
	public void ExportTriangle(TriangleAdapter shape) {
		System.out.printf("<graphObject type=\"%s\" x1=\"%d\" y1=\"%d\" x2=\"%d\" y2=\"%d\" x3=\"%d\" y3=\"%d\" color=\"%s\" />", 
				shape.getClass().toString(),
				shape.getPoint1().getX(), shape.getPoint1().getY(), 
				shape.getPoint2().getX(), shape.getPoint2().getY(),
